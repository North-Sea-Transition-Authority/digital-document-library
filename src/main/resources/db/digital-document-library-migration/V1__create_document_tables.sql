...
, CONSTRAINT doc_lib_doc_templates_pk PRIMARY KEY (id)
, CONSTRAINT doc_lib_doc_templates_mnemonic_unq UNIQUE (mnemonic)
, CONSTRAINT doc_lib_doc_templates_display_order_unq UNIQUE (display_order)
);
...
, has_page_break_before BOOLEAN NOT NULL
, display_order INTEGER NOT NULL
, CONSTRAINT doc_lib_doc_template_sections_pk PRIMARY KEY (id)
, CONSTRAINT doc_lib_doc_template_sections_doc_template_id_fk FOREIGN KEY (document_template_id) REFERENCES document_library_document_templates (id)
, CONSTRAINT doc_lib_doc_template_sections_parent_id_fk FOREIGN KEY (parent_id) REFERENCES document_library_document_template_sections (id)
...
, CONSTRAINT doc_lib_doc_template_sections_parent_id_display_order_unq UNIQUE (parent_id, display_order) DEFERRABLE INITIALLY DEFERRED
);

CREATE INDEX doc_library_doc_template_sections_doc_template_id_idx ON document_library_document_template_sections (document_template_id);

CREATE INDEX doc_library_doc_template_sections_parent_id_idx ON document_library_document_template_sections (parent_id);
...
, CONSTRAINT doc_lib_doc_instances_item_ref_item_type_doc_template_unq UNIQUE (item_reference, item_type, document_template_id)
, CONSTRAINT doc_lib_doc_instances_doc_template_id_fk FOREIGN KEY (document_template_id) REFERENCES document_library_document_templates (id)
);
